             ...
             <form action="<?=$_base['objeto']?>alterar_grv" class="form-horizontal" method="post">  						
              ...
              <fieldset> 
                ...
                <div class="form-group">
                  <label class="col-md-12" >Titulo <?=ajuda('O título é visual, porem prefira titulos simples para facilitar nas integrações do sistema. Ex: facebook, instagram, etc...')?></label>
                  <div class="col-md-7">
               ...
               <div class="form-group">
                <label class="col-md-12" >Endereço <?=ajuda('Link de destino para sua rede social, obs: para integração com instagram é preferivel que termine o link com uma barra (/).')?></label>
                <div class="col-md-7">
        ...
        <div id="imagem" class="tab-pane <?php if($aba_selecionada == "imagem"){ echo "active"; } ?>" >
          <?php if(!$data->imagem){ ?>
            <form action="<?=$_base['objeto']?>imagem/codigo/<?=$data->codigo?>" method="post" enctype="multipart/form-data">
              ...
              <fieldset> 
                <label>Imagem <?=ajuda('Icone da rede social, preferencialmente imagem em png com fundo transparente e resolução de no máximo 100 pixels proporcionais.')?></label> 
